...
<<<<<<< HEAD
  ...
  if (currentAnamnesis.city && currentAnamnesis.cityMaxTemp !== undefined && currentAnamnesis.cityAvgTemp !== undefined && currentAnamnesis.cityMinTemp !== undefined) {
    weatherInfoForSystem = `Dados climáticos para ${currentAnamnesis.city}: Temp. Média ${currentAnamnesis.cityAvgTemp}°C, Máx ${currentAnamnesis.cityMaxTemp}°C, Mín ${currentAnamnesis.cityMinTemp}°C. Clima: ${currentAnamnesis.cityWeatherDescription || 'N/A'}. Considere isso para refrigeração.`;
  } else if (currentAnamnesis.city && currentAnamnesis.cityMaxTemp !== undefined && currentAnamnesis.cityAvgTemp !== undefined) {
...
- Localização e Clima: 
  ...
  - Temperatura Mínima da Cidade: ${requirements.cityMinTemp !== undefined ? requirements.cityMinTemp + '°C' : 'N/A'}
