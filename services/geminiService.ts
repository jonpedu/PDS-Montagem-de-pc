...
import { PreferenciaUsuarioInput, ChatMessage, Componente, Ambiente, PerfilPCDetalhado } from '../types';
...
if (!API_KEY) {
  console.error("GEMINI_API_KEY não está configurada. Por favor, defina GEMINI_API_KEY no arquivo .env ou .env.local");
}
